...
<div class="container-fluid mt-5 pt-5">
                ...
                $sql = "SELECT T.TenderNo, T.Department, T.Description, T.filename, B.Charge, B.Months, T.DueDate FROM tender AS T JOIN bids AS B ON B.TenderID=T.TenderID AND B.OrgID='$Orgid' WHERE (`Department` LIKE '%".$searchquery."%') OR (`Description` LIKE '%".$searchquery."%')";
