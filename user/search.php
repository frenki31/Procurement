...
<body>
    ...
    <?php
                ...
                $sql = "SELECT TenderID,TenderNo,Department,Description,Price,DueDate,Duration,filename,CurrentTime FROM tender WHERE (`Department` LIKE '%".$searchquery."%') OR (`Description` LIKE '%".$searchquery."%')";
